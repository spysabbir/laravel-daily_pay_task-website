...
(function($) {
    ...
    $(function() {
        ...
        function addActiveClass(element) {
            ...
            // Check if the current element's href matches the current URL
            if (element.attr('href') === currentUrl) {
                // Add 'active' class to the link
                element.addClass('active');

                // Add 'active' class to its parent nav-item
                element.parents('.nav-item').addClass('active');

                // If it's in a submenu, expand the menu
        ...
        // Apply the function to all sidebar links
        $('.nav li a').each(function () {
            const $this = $(this);
            addActiveClass($this);
        });

        // Apply the function to all horizontal menu links
