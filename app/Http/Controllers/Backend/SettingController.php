...
class SettingController extends Controller implements HasMiddleware
{
    ...
    public function defaultSettingUpdate(Request $request){
        $request->validate([
            ...
            'deposit_from_withdraw_balance_charge_percentage' => 'required',
        ...
        $defaultSetting->update([
            ...
            'deposit_from_withdraw_balance_charge_percentage' => $request->deposit_from_withdraw_balance_charge_percentage,
