...
class SettingController extends Controller
{
    ...
    public function defaultSettingUpdate(Request $request){
        $request->validate([
            ...
            'task_posting_additional_screenshot_charge' => 'required',
            'task_posting_boosted_time_charge' => 'required',
            'task_posting_additional_running_day_charge' => 'required',
        ...
        $defaultSetting->update([
            ...
            'task_posting_additional_screenshot_charge' => $request->task_posting_additional_screenshot_charge,
            'task_posting_boosted_time_charge' => $request->task_posting_boosted_time_charge,
            'task_posting_additional_running_day_charge' => $request->task_posting_additional_running_day_charge,
