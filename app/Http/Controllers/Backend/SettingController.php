...
class SettingController extends Controller implements HasMiddleware
{
    ...
    public function defaultSettingUpdate(Request $request){
        $request->validate([
            ...
            'withdraw_from_deposit_balance_charge_percentage' => 'required',
        ...
        $defaultSetting->update([
            ...
            'withdraw_from_deposit_balance_charge_percentage' => $request->withdraw_from_deposit_balance_charge_percentage,
