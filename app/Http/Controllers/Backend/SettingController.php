...
class SettingController extends Controller implements HasMiddleware
{
    ...
    public function defaultSettingUpdate(Request $request){
        $request->validate([
            ...
            'deposit_balance_from_withdraw_balance_charge_percentage' => 'required',
            'withdraw_balance_from_deposit_balance_charge_percentage' => 'required',
        ...
        $defaultSetting->update([
            ...
            'deposit_balance_from_withdraw_balance_charge_percentage' => $request->deposit_balance_from_withdraw_balance_charge_percentage,
            'withdraw_balance_from_deposit_balance_charge_percentage' => $request->withdraw_balance_from_deposit_balance_charge_percentage,
