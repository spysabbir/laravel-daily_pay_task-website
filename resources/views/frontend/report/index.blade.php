            ...
            <div class="card-header d-flex justify-content-between">
                <div class="text">
                    ...
                    <p class="card-description text-info">
                        Note: Hi user, This is the report list so when you will report others you will can see this here. If your report is ok report status will be showing received but not ok will be showing false. Also you will can see here your report feedback from admin panel. Alert: If your report over and over false your account will suspended so do not send false evidence to us for checking. Please contact us if you face any problem.
                    </p>
                </div>
            </div>
            <div class="card-body">
