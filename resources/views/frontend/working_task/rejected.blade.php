    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <div>
                    <a href="{{ route('working_task.list.pending') }}" class="btn btn-primary">Pending</a>
                    <a href="{{ route('working_task.list.reviewed') }}" class="btn btn-warning">Reviewed</a>
                </div>
            </div>
            <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        $('#allDataTable').DataTable({
            ...
            searching: true,
            ajax: {
                url: "{{ route('working_task.list.rejected') }}",
                data: function (d) {
        ...
        $(document).on('click', '.viewBtn', function () {
            var id = $(this).data('id');
            var url = "{{ route('rejected.working_task.check', ":id") }}";
