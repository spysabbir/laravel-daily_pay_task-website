            ...
            <div class="card-body">
                ...
                <div class="mt-3 bg-dark p-3 rounded">
                    ...
                    <strong class="text-success">
                        {{ get_default_settings('referal_registion_bonus_amount') * App\Models\User::where('referred_by', Auth::user()->id)->count() }} {{ get_default_settings('site_currency') }} earned from your refferal link.
                    </strong>
                    <p class="mt-3">
