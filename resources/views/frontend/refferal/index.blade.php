            ...
            <div class="card-body">
                ...
                <div class="mt-3 bg-dark p-3 rounded">
                    ...
                    <strong class="text-success">
                        {{ get_default_settings('referal_registion_bonus_amount') * App\Models\User::where('referred_by', Auth::user()->id)->count() }} {{ get_site_settings('site_currency') }} earned from your refferal link.
                    </strong>
                    <p class="mt-3">
                        Share your referral link with your friends and earn {{ get_default_settings('referal_registion_bonus_amount') }} {{ get_site_settings('site_currency') }} for each friend that signs up using your link.
                    </p>
                    <p class="mt-3">
                    ...
                    <p class="mt-3">
                        Your friends will also get {{ get_default_settings('referal_registion_bonus_amount') }} {{ get_site_settings('site_currency') }} when they sign up using your referral link.
                    </p>
                    <p class="mt-3">
