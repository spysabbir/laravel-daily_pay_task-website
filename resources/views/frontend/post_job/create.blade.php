    ...
    $(document).ready(function() {
        $('#wizard').steps({
            ...
            onFinished: function(event, currentIndex) {
                ...
                var total_job_cost = parseFloat($('#total_job_cost').val());

                if(total_job_cost < job_posting_min_budget) {
                    toastr.warning('Your total job cost must be ' + job_posting_min_budget + ' {{ get_site_settings('site_currency_symbol') }}.');
                    isValid = false;
                }else if (total_job_cost > user_deposit_balance) {
        ...
        // Initialize the total job cost on page load
        calculateTotalJobCost();
    });
</script>
@endsection
