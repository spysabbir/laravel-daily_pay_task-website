<div class="row">
    <marquee class="mb-3">
        <strong class="text-danger">Warning: If you do not approve or reject the Task Proof within 72 hours of submitting the worker Task Proof, the Task Proof will be automatically approved. If you reject the task proof then worker can send requesting to us for reviewing task proof within 24 hours. Admin will check the proof and if it is correct then the worker will be paid or if the proof is wrong then the worker will not be paid. Because of this, only Rejected money will be on hold for 72 hours because you Proof Rejected. If the worker does not request for review within 24 hours, your money will be automatically add your deposit balance after task work duration expire. If the worker request for review within 24 hours, the admin will review the proof within 48 hours. After review checking workers will get feedback notification from admin panel. Please be careful and work well with integrity and don't intentionally reject someone's work.</strong>
    </marquee>
    <div class="col-lg-8">
