            ...
            <div class="card-header d-flex justify-content-between">
                <div class="text">
                    ...
                    <p class="card-description text-info">
                        Note: Hi user, below tasks list is your canceled task. Tasks will removed from below list after 7 days so task removal countdown will start automatically. Please contact us if you face any problem.
                    </p>
                </div>
                <div>
