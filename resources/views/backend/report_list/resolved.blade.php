...
@section('title', 'Report User - Resolved')
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="text">
                    <h3 class="card-title">Report User - Resolved</h3>
                </div>
                <div class="action-btn">
                    <a href="{{ route('backend.report_list.pending') }}" class="btn btn-primary">Pending List</a>
                </div>
            </div>
            <div class="card-body">
