    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h3 class="card-title">Task List (Pending)</h3>
            </div>
            <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        $('#pendingDataTable').DataTable({
            ...
            searching: true,
            ajax: {
                url: "{{ route('backend.post_task_list.pending') }}",
            },
            columns: [
        ...
        $(document).on('click', '.viewBtn', function () {
            var id = $(this).data('id');
            var url = "{{ route('backend.pending.post_task_view', ":id") }}";
        ...
        $("body").on("submit", "#editForm", function(e){
            ...
            var url = "{{ route('backend.post_task_status_update', ":id") }}";
            url = url.replace(':id', id)
            $.ajax({
                url: url,
                type: "PUT",
