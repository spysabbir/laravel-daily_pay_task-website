<div class="row">
    ...
    <div class="col-lg-6">
        <div class="alert alert-danger alert-dismissible fade show mb-3" role="alert">
            ...
            <strong>Warning!</strong> This job post has been canceled. <br>
            <span>Canceled By: {{ $jobPost->canceledBy->name }}</span> <br>
            <span>Canceled At: {{ date('d-m-Y h:i:s A', strtotime($jobPost->canceled_at)) }}</span> <br>
            <span>Cancellation Reason: {{ $jobPost->cancellation_reason }}</span> <br>
        </div>
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">
