<div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                    <span class="text-primary">( Charge: {{ $postTask->boosting_time }} * {{ get_site_settings('site_currency_symbol') }} {{ get_default_settings('task_posting_boosting_timee_charge') }} = {{ get_site_settings('site_currency_symbol') }} {{ $postTask->boosting_time / 15 * get_default_settings('task_postingbboosting_timeeee_charge') }} )</span>
                                </td>
                            </tr>
                            <tr>
                                <td>Work Duration</td>
    ...
    <div class="col-lg-6">
        <div class="alert alert-success alert-dismissible fade show mb-3" role="alert">
            ...
            <strong>Warning!</strong> This task post has been completed. <br>
            <span>Canceled At: {{ date('d M, Y h:i:s A', strtotime($postTask->completed_at)) }}</span>
        </div>
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">
