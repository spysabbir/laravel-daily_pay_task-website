...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Permission::insert([
            ...
            ['name' => 'backend.expenses.statement', 'group_name' => 'AccountsStatementManagement', 'guard_name' => 'web'],
            ...
            ['name' => 'bonus.report', 'group_name' => 'ReportListManagement', 'guard_name' => 'web'],
            ['name' => 'expense.report', 'group_name' => 'ReportListManagement', 'guard_name' => 'web'],
