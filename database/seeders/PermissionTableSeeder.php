...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Permission::insert([
            ...
            ['name' => 'sub_category.status', 'group_name' => 'SubCategoryManagement', 'guard_name' => 'web'],
            ...
            ['name' => 'child_category.status', 'group_name' => 'ChildCategoryManagement', 'guard_name' => 'web'],
            ...
            ['name' => 'worked_task_list.checking', 'group_name' => 'WorkedTaskManagement', 'guard_name' => 'web'],
