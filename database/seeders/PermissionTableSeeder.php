...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Permission::insert([
            ...
            ['name' => 'JobPostChargeMenu', 'group_name' => 'JobPostChargeManagement', 'guard_name' => 'web'],
            ['name' => 'job_post_charge.index', 'group_name' => 'JobPostChargeManagement', 'guard_name' => 'web'],
            ['name' => 'job_post_charge.create', 'group_name' => 'JobPostChargeManagement', 'guard_name' => 'web'],
            ['name' => 'job_post_charge.edit', 'group_name' => 'JobPostChargeManagement', 'guard_name' => 'web'],
            ['name' => 'job_post_charge.destroy', 'group_name' => 'JobPostChargeManagement', 'guard_name' => 'web'],
            ['name' => 'job_post_charge.trash', 'group_name' => 'JobPostChargeManagement', 'guard_name' => 'web'],
            ['name' => 'job_post_charge.restore', 'group_name' => 'JobPostChargeManagement', 'guard_name' => 'web'],
            ['name' => 'job_post_charge.delete', 'group_name' => 'JobPostChargeManagement', 'guard_name' => 'web'],
