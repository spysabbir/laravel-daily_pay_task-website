...
class DefaultSettingTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $setting = [
            ...
            'deposit_balance_transfer_charge_percentage' => 2.00, // every deposit
            'withdraw_balance_transfer_charge_percentage' => 2.00, // every withdraw
            ...
            'user_blocked_instant_resolved_charge' => 20, // every blocked
        ];
